...
.grid(:class="{ timeon: time }")
	component(:is="MySelect" :label="props.first" v-model="regModel" :options="region")
	component(:is="MySelect" :label="props.second" v-model="groupModel" :options="group")
	component(:is="MySelect" :label="props.third" v-model="operModel" :options="operator")
...
const operator = ['Все', 'Интегральный', 'Чеклист 1', 'Чеклист 2']
