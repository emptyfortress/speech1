...
q-expansion-item(v-model="veha")
	...
	q-card-section.q-px-md.q-pt-md
		.grid
			...
			q-card
				component(:is="CatCharts" v-if="selected.length === 0")
...
import { cols, catrows } from '@/stores/vehi'
import CatCharts from '@/components/common/CatCharts.vue'
